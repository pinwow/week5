...
function init(){
  ...
  ticketCardArea.innerHTML = innerHtml;
}
init();
...
regionSearch.addEventListener('change',function(e){
  ...
  data.forEach(function(item){
    if(e.target.value == '全部地區'){
      innerHTML = innerHTML + `<li class="ticketCard">
                                <div class="ticketCard-img">
                                  <a href="#">
                                    <img src="${item.imgUrl}"
                                      alt="">
...
addBtn.addEventListener('click', function(e){
  let obj = {
    ...
    imgUrl:'https://github.com/hexschool/2022-web-layout-training/blob/main/js_week5/travel_1.png?raw=true', // https://github.com/hexschool/2022-web-layout-training/blob/main/js_week5/travel_1.png?raw=true
    area:area.value,
    price:price.value,
    group:group.value,
    rate:rate.value,
